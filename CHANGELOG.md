...
- **La percentuale del giro dice rispetto a che cosa.** Prima era la posizione del giro fra il più veloce e il più lento, e cambiava formula quando i giri precedenti erano uguali. Ora sono due variazioni dette a parole: rispetto al giro precedente e rispetto alla media dei giri precedenti.
